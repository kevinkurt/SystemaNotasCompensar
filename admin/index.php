...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
    ...
    <ul class="nav navbar-nav ">
      <li class="nav-item"><a class="nav-link" href="index.php?page=user-profile"><i class="fa fa-user"></i> Bienvenido, <?php echo $showrow['name']; ?>!</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="index.php?page=all-users" class="list-group-item list-group-item-action"><i class="fa fa-users"></i> Todos los Docentes</a>
              <a href="index.php?page=user-profile" class="list-group-item list-group-item-action"><i class="fa fa-user"></i> Perfil del  Docente</a>
            </div>
          </div>
          <div class="col-md-9">
             <div class="content">
